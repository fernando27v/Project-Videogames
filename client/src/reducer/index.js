...
import {GET_ALLGAMES, GET_GENRES,GET_GAMEBYID,GET_PLATFORMS,FILTER_GAMES,FILTER_GENRES,FILTER_ORDER,ONSEARCH, DELETE_SEARCHED, DELETE_DETAIL} from '../actions/actions_types'
...
export default function reducer(state = inicialState,action){
    ...
    switch(action.type){
        ...
        case FILTER_ORDER:
            if((action.payload === "a_z") && (state.filterGames=== "all") && (state.filterGenres !="all")){
            ...
            }else if((action.payload === "z_a") && (state.filterGames=== "all") && (state.filterGenres !="all")){
                var ordenado = state.arrayFill.map((vg) => vg)
                function SortArray(a, b){
            ...
            }else if((action.payload === "a_z") && (state.filterGames=== "existed") && (state.filterGenres !="all")){
                var ordenado = state.arrayFill.map((vg) => vg)
                function SortArray(a, b){
                    if (a.name.toLowerCase() < b.name.toLowerCase()) {return -1;}
                    if (a.name.toLowerCase() > b.name.toLowerCase()) {return 1;}
            ...
            }else if((action.payload === "z_a") && (state.filterGames=== "existed") && (state.filterGenres !="all")){
                var ordenado = state.arrayFill.map((vg) => vg)
                function SortArray(a, b){
                    if (b.name.toLowerCase() > a.name.toLowerCase()) {return 1;}
                    if (b.name.toLowerCase() < a.name.toLowerCase()) {return -1;}
            ...
            }else if((action.payload === "a_z") && (state.filterGames=== "created") && (state.filterGenres !="all")){
                var ordenado = state.arrayFill.map((vg) => vg)
                function SortArray(a, b){
                    if (a.name.toLowerCase() < b.name.toLowerCase()) {return -1;}
                    if (a.name.toLowerCase() > b.name.toLowerCase()) {return 1;}
            ...
            }else if((action.payload === "z_a") && (state.filterGames=== "created") && (state.filterGenres !="all")){
                var ordenado = state.arrayFill.map((vg) => vg)
                function SortArray(a, b){
                    if (b.name.toLowerCase() > a.name.toLowerCase()) {return 1;}
                    if (b.name.toLowerCase() < a.name.toLowerCase()) {return -1;}
            ...
            }else if((action.payload === "0_5") && (state.filterGames=== "all") && (state.filterGenres !="all")){
                var ordenado = state.arrayFill.map((vg) => vg)
                function SortArray(a, b){
            ...
            }else if((action.payload === "5_0") && (state.filterGames=== "all") && (state.filterGenres !="all")){
                var ordenado = state.arrayFill.map((vg) => vg)
                function SortArray(a, b){
            ...
            }else if((action.payload === "0_5") && (state.filterGames=== "existed") && (state.filterGenres !="all")){
                var ordenado = state.arrayFill.map((vg) => vg)
                function SortArray(a, b){
                    if (Number(a.rating) < Number(b.rating)) {return -1;}
                    if (Number(a.rating) > Number(b.rating)) {return 1;}
            ...
            }else if((action.payload === "5_0") && (state.filterGames=== "existed") && (state.filterGenres !="all")){
                var ordenado = state.arrayFill.map((vg) => vg)
                function SortArray(a, b){
                    if (Number(b.rating) > Number(a.rating)) {return 1;}
                    if (Number(b.rating) < Number(a.rating)) {return -1;}
            ...
            }else if((action.payload === "0_5") && (state.filterGames=== "created") && (state.filterGenres !="all")){
                var ordenado = state.arrayFill.map((vg) => vg)
                function SortArray(a, b){
                    if (Number(a.rating) < Number(b.rating)) {return -1;}
                    if (Number(a.rating) > Number(b.rating)) {return 1;}
            ...
            }else if((action.payload === "5_0") && (state.filterGames=== "created") && (state.filterGenres !="all")){
                var ordenado = state.arrayFill.map((vg) => vg)
                function SortArray(a, b){
                    if (Number(b.rating) > Number(a.rating)) {return 1;}
                    if (Number(b.rating) < Number(a.rating)) {return -1;}
            ...
            }else if((action.payload === "a_z") && (state.filterGames=== "all") && (state.filterGenres ==="all")){
